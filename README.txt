...
This repository contains an end-to-end data analysis project showcasing proficiency in data organization, analytics, and visualization using Microsoft Excel. The project evaluates over 500 employee sales records across multiple regions and departments, transforming raw, unstructured data into an interactive, professional dashboard.

## Project Overview

The goal of this project is to analyze employee sales performance and generate actionable business insights. It demonstrates a complete data workflow—from cleaning and structuring to advanced analysis and visual storytelling.
...
Raw data often contains formatting inconsistencies, trailing spaces, and mixed data types. The following techniques and Excel functions were utilized to sanitize the dataset:
...
- **Full Interactive Analysis Spreadsheet:** [View on Google Sheets](https://docs.google.com/spreadsheets/d/1oAkeeufks5AX0kB8vxk12YJBxK_fy5Eh/edit?usp=sharing&ouid=113262483247913212892&rtpof=true&sd=true)
- **Consolidated/**
